...
// SnakeGameDoc.cpp : CSnakeGameDoc 类的实现
//
...
// 缩略图的支持
void CSnakeGameDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CSnakeGameDoc::InitializeSearchContent()
{
...
void CSnakeGameDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
